...
const translations = {
    es: {
        ...
        videoteca_list_title: 'Lista de Partidos',
        videoteca_playing: 'REPRODUCIENDO',
        videoteca_loading: 'Cargando videoteca...',
        videoteca_empty: 'No se encontraron videos en la lista.',
        videoteca_error: 'Error al cargar la videoteca.',
    ...
    en: {
        ...
        videoteca_list_title: 'Match List',
        videoteca_playing: 'NOW PLAYING',
        videoteca_loading: 'Loading video library...',
        videoteca_empty: 'No videos found in the list.',
        videoteca_error: 'Error loading the video library.',
